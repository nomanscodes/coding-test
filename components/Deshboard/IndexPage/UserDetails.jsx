...
const UserDetails = () => {
    return (
        ...
        <div className=" bg-white rounded-sm border mt-7 shadow">
            <header className="px-5 py-4 border-b border-gray-100">
                <h2 className="font-bold text-[#2d6d6f] uppercase">Customer CAMPAIGNS</h2>
            </header>
            <div className="p-3">
                <div className="">
                    <table className="table-auto w-full">
                        <thead className="text-xs font-semibold uppercase text-white bg-[#2d6d6f]">
                            <tr>
                        ...
                        <tbody className="text-sm divide-y divide-gray-100">
                            <tr>
                                ...
                                <td className="p-2 whitespace-nowrap">
                                    <div className="text-left font-medium text-[#2d6d6f]">
                                        $2,890.66
                                    </div>
                                </td>
                                <td className="p-2 whitespace-nowrap">
